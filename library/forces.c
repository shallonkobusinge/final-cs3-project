...
force_creator_data_t *force_creator_data_init(force_creator_t force_creator,
                                              void *aux)
{
...
void force_creator_data_free(force_creator_data_t *data)
{
  list_free(data->bodies);
  body_aux_free(data->aux);
  free(data);
}
