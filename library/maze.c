...
static btn_element_t mission_btn_elements[] = {
    {
        .text.frame = (SDL_Rect){SDL_SCREEN_CENTER.x - 40, SDL_SCREEN_CENTER.y + 45, 90, 48},
        ...
        .img.frame = (SDL_Rect){SDL_SCREEN_CENTER.x - 70, SDL_SCREEN_CENTER.y + 30, 200, 80},
    ...
    img_element_t mission_img_elements[] = {
        {
            ...
            .frame = (SDL_Rect){SDL_SCREEN_CENTER.x - 100, SDL_SCREEN_CENTER.y - 100, 300, 300},
        },
    };
